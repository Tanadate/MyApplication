...
public class DoctorActivity extends AppCompatActivity {
    ...
    private String urlPHP = "https://www.androidthai.in.th/sam/getUserWhereidArt.php";
    ...
    private void getUser() {
        ...
        Log.d("26.JanV1", "id Receive ==> " + idString);
        ...
        try {
            ...
            Log.d("26.JanV1", "json Doctor ==>" + json);
    ...
    private void createToolbar() {
        ...
        Toolbar toolbar = findViewById(R.id.toolbatDoctor);
