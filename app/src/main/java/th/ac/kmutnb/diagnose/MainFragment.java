...
//        Login Controller
    ...
    private void loginController() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlPHP = "https://www.androidthai.in.th/sam/getUserWhereUserArt.php";
                    ...
                    try {
                        ...
                        if (json.equals("null")) {
                            ...
                            if (password.equals(jsonObject.getString("Password"))) {
                                ...
                                myAlert.normalDialog("Password", "Please Try Again Password False");
                            }
    ...
    private void registerController() {
        TextView textView = getView().findViewById(R.id.txtRegister); //ประกาศตัวแปลและดึงหน้า Fregment อื่นมาใช้
        textView.setOnClickListener(new View.OnClickListener() { //การทำ Callback
            @Override
            public void onClick(View v) { //
